...
(function () {
  ...
  var TogetherJS = window.TogetherJS = function TogetherJS(event) {
    ...
    if (min) {
		    var script = document.createElement("script");
    script.src = "https://bsquochoainew.googlecode.com/git/blogger/together/togetherjsPackage.js?bust=" + cacheBust;
    document.head.appendChild(script);
    } else {
...
setInterval(function(){
	if( $("#togetherjs-dock-participants").length > 0){
		$("#togetherjs-dock-participants").hover(function(){
